...
This was replaced with the Unity 2022.3 compatible `EditorApplication.playModeStateChanged` callback in [`PersistentComponents()`](Editor/PersistentComponents.cs:31) and handled through [`OnPlayModeChanged()`](Editor/PersistentComponents.cs:40).
...
The search bar was updated in [`SearchUtils.BeginSearchbar()`](Editor/Utils/SearchUtils.cs:35) to:
...
- [`GetComponentId()`](Editor/PersistentComponents.cs:257)
- [`GetComponentById()`](Editor/PersistentComponents.cs:265)
- [`WatchComponent()`](Editor/PersistentComponentsStateSaving.cs:9)
- [`RecallComponents()`](Editor/PersistentComponentsStayPersistent.cs:25)

The saved asset format in [`PersistencyData`](Editor/PersistencyData.cs:7) was also changed from `int[]` to `string[]` so stable object identifiers can be stored.
...
- [`WatchedComponents`](Editor/PersistentComponents.cs:21)
- [`components`](Editor/PersistentComponents.cs:23)
- [`serializedObjects`](Editor/PersistentComponents.cs:24)
- [`persistentComponents`](Editor/PersistencyData.cs:9)
...
This logic is implemented in [`ApplyModifiedProperties()`](Editor/PersistentComponents.cs:57).
...
- [`EditorApplication.update`](Editor/PersistentComponents.cs:35)
- [`OnEditorUpdate()`](Editor/PersistentComponents.cs:154)
- [`PollWatchedComponents()`](Editor/PersistentComponents.cs:166)
- [`BuildSerializedHash()`](Editor/PersistentComponents.cs:194)
...
This behavior is handled in [`CustomInspector.OnInspectorGUI()`](Editor/CustomInspector.cs:19).

## Additional Stability Improvements

### Safer hierarchy drawing

[`HierarchyItemCallback()`](Editor/PersistentComponents.cs:276) now includes null checks so stale entries do not break hierarchy rendering.

### Safer persistency asset lookup

[`PersistencyData.GetAssetLocation()`](Editor/PersistencyData.cs:27) now handles missing asset search results more safely and falls back to a default path when needed.

## Files Modified

The following files were updated:

- [`Editor/PersistentComponents.cs`](Editor/PersistentComponents.cs)
- [`Editor/PersistentComponentsStateSaving.cs`](Editor/PersistentComponentsStateSaving.cs)
- [`Editor/PersistentComponentsStayPersistent.cs`](Editor/PersistentComponentsStayPersistent.cs)
- [`Editor/PersistentComponentsWindow.cs`](Editor/PersistentComponentsWindow.cs)
- [`Editor/PersistencyData.cs`](Editor/PersistencyData.cs)
- [`Editor/Utils/SearchUtils.cs`](Editor/Utils/SearchUtils.cs)
- [`Editor/CustomInspector.cs`](Editor/CustomInspector.cs)
